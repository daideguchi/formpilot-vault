...
const TEXT_RULES = [
  [/メール|mail|e-mail/i, "person.email.primary", 0.96],
  [/携帯|電話|tel|phone/i, "person.phone.mobile_auto", 0.9],
  [/郵便番号|zip|postal/i, "person.address.postal_code_auto", 0.96],
  [/都道府県|pref/i, "person.address.prefecture", 0.95],
  [/市区町村|市町村|区市町村|city/i, "person.address.city", 0.88],
  [/建物|マンション|部屋|号室|address.*2/i, "person.address.line2", 0.86],
  [/番地|丁目|住所1|address.*1/i, "person.address.line1", 0.86],
  [/住所|所在地|address/i, "person.address.full", 0.8],
  ...
  [/^姓$|苗字|名字|last name|family name/i, "person.name.last", 0.96],
  [/^名$|お名前.*名|first name|given name/i, "person.name.first", 0.92],
  [/氏名|お名前|名前|name/i, "person.name.full", 0.82],
  [/生年|年.*生まれ|birth.*year/i, "person.birthdate.year", 0.9],
  [/生月|月.*生まれ|birth.*month/i, "person.birthdate.month", 0.9],
  [/生日|日.*生まれ|birth.*day/i, "person.birthdate.day", 0.9],
  [/生年月日|誕生日|birthday|birthdate/i, "person.birthdate.iso", 0.86],
  [/性別|gender/i, "person.gender", 0.88],
  [/会社名|法人名|貴社名|organization|company/i, "company.name", 0.9],
  [/部署|部門|department|division/i, "company.department", 0.88],
  [/役職|肩書|position|title/i, "company.title", 0.86],
  [/webサイト|website|url/i, "company.website", 0.82],
  [/パスワード|password/i, "account.password.generated", 0.9]
];
