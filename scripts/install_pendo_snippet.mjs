...
const surfacePaths = [
  ...
  { path: path.join(root, 'form-autofill.html'), visitorId: `${visitorId}-form-autofill` },
  { path: path.join(root, 'signup-autofill.html'), visitorId: `${visitorId}-signup-autofill` },
  { path: path.join(root, 'contact-form-autofill.html'), visitorId: `${visitorId}-contact-form-autofill` },
  ...
  { path: path.join(root, 'site', 'form-autofill.html'), visitorId: `${visitorId}-form-autofill` },
  { path: path.join(root, 'site', 'signup-autofill.html'), visitorId: `${visitorId}-signup-autofill` },
  { path: path.join(root, 'site', 'contact-form-autofill.html'), visitorId: `${visitorId}-contact-form-autofill` },
