...
2026-06-01のDD判断として、世界配信は「あとで翻訳を足す施策」ではなく、初期リリースの事業戦略に昇格します。日本語フォームの強さは差別化の入口として残しつつ、売り場、LP、拡張UI、schema推論、Vault/Memoryを最初からグローバル前提で扱います。
...
Freeは月20回にします。世界配信では、Freeを広く撒きすぎないことが重要です。

- Free: 月20回、1プロフィール、ローカル基本入力
...
世界配信では「海外でも使えるから無料で広げる」ではなく、「月20回で価値を体験させ、継続利用はPlus以上へ寄せる」を守ります。多言語対応は獲得面を広げる武器であり、課金面では使用回数、複数プロフィール、会社プロフィール、サイト別Memoryを有料理由にします。
...
- Extension UIは152キー x 21 localeで欠落を出さない
