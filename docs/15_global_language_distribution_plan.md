...
Freeは月5回にします。世界配信では、Freeを広く撒きすぎないことが重要です。
...
世界配信では「海外でも使えるから無料で広げる」ではなく、「月5回で価値を体験させ、継続利用はPlus以上へ寄せる」を守ります。多言語対応は獲得面を広げる武器であり、課金面では使用回数、複数プロフィール、会社プロフィール、サイト別Memoryを有料理由にします。
